...
const SaffForm = ({ nextStep }) => {
    ...
    return (
        ...
        <div className='container'>
            ...
            >
                {({ handleSubmit, handleChange, values, touched, errors }) => (
                    <Form noValidate onSubmit={handleSubmit}>
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col} md="8" controlId="validationFormikProfile">
                                <FloatingLabel
                            ...
                            <Form.Group as={Col} md="4" controlId="validationFormikRole">
                                <FloatingLabel
                                    controlId="floatingSelectGrid"
                                    label="Staff Roles"
                                >
            ...
            <Modal show={showModal} onHide={handleClose} style={{background: "rgba(0, 0, 0, 0.50,)"}}>
                <Modal.Header closeButton>
                    <Modal.Title>Admin Login</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container>
                        <AdminModelBox setFormData={handleSetFormData} />
                    </Container>
                </Modal.Body>
            </Modal>
        </div>
...
// Define prop-types for SaffForm component
SaffForm.propTypes = {
    nextStep: PropTypes.func.isRequired,
};

export default SaffForm;